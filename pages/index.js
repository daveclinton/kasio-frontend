  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Kasio Digital Connections | Your World of Electronics</title>
          <meta name="description" content="Your World of Electronics" />
          <meta
            property="og:title"
            content="Kasio Digital Connections"
            key="title"
          />
        </Head>
        <div
